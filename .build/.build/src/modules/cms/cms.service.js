...
exports.updateCmsSection = exports.getCms = void 0;
...
const getCms = async () => {
    ...
    await redisClient_1.cache.set(cacheKey, data, 3600); // Cache for 1 hour
    return data;
};
exports.getCms = getCms;
const updateCmsSection = async (sectionPath, data) => {
    const current = (await (0, exports.getCms)());
    ...
    // Invalidate cache
    await redisClient_1.cache.del('cms:site');
    return updated;
};
exports.updateCmsSection = updateCmsSection;
const getDefaultCms = () => ({
    PK: CMS_PK, SK: 'CMS',
    home: {
        carousel: [
